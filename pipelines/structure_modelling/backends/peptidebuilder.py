...
class PeptideBuilderBackend:
    ...
    def minimise_peptide(self, pdb_path, out_pdb):
        """
        Minimizes peptide with OpenMM, adding hydrogens and standard termini (charged).
        """
        ...
        # Add hydrogens (automatically adds N/C-terminal groups, NH3+/COO-)
    ...
    def run(self):
        # Loop over sequences and build + minimize
        results = {}
