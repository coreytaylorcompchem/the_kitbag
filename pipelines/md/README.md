...
* Free energy 
    * Use the OpenFE env for running simulations they provide during installation rather than the general MD env provided here. The code base is being revised fairly regularly so dependencies will change with newer versions.
